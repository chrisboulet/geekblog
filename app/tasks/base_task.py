...
class JobAwareTask(Task):
    ...
    def update_state_with_db(
        self, state: str = "PROGRESS", meta: Optional[Dict[str, Any]] = None
    ) -> None:
        """
    ...
    def on_success(self, retval, task_id, args, kwargs):
        ...
        try:
            ...
            job_service.complete_job(
                db=db, job_id=task_id, success=True, result_summary=result_summary
            )
        except Exception as e:
    ...
    def on_failure(self, exc, task_id, args, kwargs, einfo):
        ...
        try:
            ...
            job_service.complete_job(
                db=db, job_id=task_id, success=False, error_message=error_message
            )
        except Exception as e:
...
def create_job_aware_task(celery_app, name: str, bind: bool = True):
    ...
    def decorator(func):
        return celery_app.task(bind=bind, base=JobAwareTask, name=name)(func)
