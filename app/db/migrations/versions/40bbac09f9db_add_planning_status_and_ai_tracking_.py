...
def upgrade() -> None:
    ...
    op.add_column(
        "projects",
        sa.Column(
            "planning_status", sa.String(), nullable=False, server_default="NOT_STARTED"
        ),
    )
    ...
    op.add_column(
        "tasks",
        sa.Column(
            "created_by_ai", sa.Boolean(), nullable=False, server_default="false"
        ),
    )
    op.add_column(
        "tasks",
        sa.Column("last_updated_by_ai_at", sa.DateTime(timezone=True), nullable=True),
    )
