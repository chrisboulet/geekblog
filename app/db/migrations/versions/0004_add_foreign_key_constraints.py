...
def downgrade() -> None:
    ...
    op.drop_constraint('async_jobs_parent_job_id_fkey', 'async_jobs', type_='foreignkey')
    op.drop_constraint('async_jobs_workflow_execution_id_fkey', 'async_jobs', type_='foreignkey')
