...
@router.post("/{project_id}/archive", response_model=schemas.ProjectWithExtensions, tags=["Project Management"])
...
@router.post("/{project_id}/unarchive", response_model=schemas.ProjectWithExtensions, tags=["Project Management"])
...
def delete_project_endpoint(project_id: int, db: Session = Depends(get_db)):
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="Cannot delete archived project. Unarchive first.")

# ====== PARAMÈTRES DE PROJET ======

@router.get("/{project_id}/settings", response_model=schemas.ProjectSettings, tags=["Project Settings"])
...
@router.put("/{project_id}/settings", response_model=schemas.ProjectWithExtensions, tags=["Project Settings"])
...
@router.post("/{project_id}/duplicate", response_model=schemas.ProjectWithExtensions, tags=["Project Management"])
...
@router.get("/filtered", response_model=List[schemas.ProjectWithExtensions], tags=["Project Search"])
...
@router.put("/{project_id}/tags", response_model=schemas.ProjectWithExtensions, tags=["Project Tags"])
